class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update) { |user| user.permit(:username, :email, :password, :password_confirmation, :current_password, :jobtitle, :biography, :quote, :facebook, :instagram, :email) }
