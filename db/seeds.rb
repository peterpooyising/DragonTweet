...
user_0 = User.create(username: 'Goku', email: 'user@example.com', password: 'password', password_confirmation: 'password', jobtitle: "Z-Fighter", biography: "Main protagonist of Dragon Ball Z" , avatar: 'http://cdn.playbuzz.com/cdn/d0b128e9-841e-4a54-928c-094123202f85/cd0e575c-440c-45ea-bce8-5950ff1574a5.png')

user_1 = User.create(username: 'Vegeta', email: 'billgates@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Saiyan Prince", biography: "Deuteragonist of Dragon Ball Z", avatar: 'https://static.comicvine.com/uploads/original/11130/111304459/5650015-vegeta_by_bardocksonic-d606hr0.png')

user_2 = User.create(username: 'Frieza' , email: 'stevejobs@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Emperor", biography: "Emperor of Universe 7", avatar: 'https://vignette.wikia.nocookie.net/vsbattles/images/7/77/500px-2204548-frieza_final_form.png/revision/latest?cb=20141015231701')

user_3 = User.create(username: 'Cell' , email: 'elonmusk@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Bio-Android", biography: "Ultimate creation of an evil scientist", avatar: 'https://vignette.wikia.nocookie.net/villains/images/6/60/Perfection.png/revision/latest?cb=20130929103157')

user_4 = User.create(username: 'Android 18' , email: 'markzuckerberg@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Andriod", biography: "Eighteenth android creation of an evil scientist", avatar: 'https://vignette.wikia.nocookie.net/deathbattle/images/3/37/Android_18.png/revision/latest?cb=20170524174351')

user_5 = User.create(username: 'Majin Buu' , email: 'jackdorsey@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Agent of Destruction", biography: "Summoning of an evil wizard", avatar: 'https://vignette.wikia.nocookie.net/villains/images/1/17/Super_Buu.png/revision/latest?cb=20130727003604')

user_6 = User.create(username: 'Gohan' , email: 'jackdorsey@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Z-Fighter", biography: "Elder son of main protagonist", avatar: 'http://img06.deviantart.net/e27e/i/2017/123/c/d/ultimate_gohan___mystic_gohan_by_aashan-db7zz6v.png')

user_7 = User.create(username: 'Trunks' , email: 'jackdorsey@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Z-Fighter", biography: "Son of deuteragonist", avatar: 'https://pbs.twimg.com/profile_images/886786124043223041/y5tN-eTH.jpg')

user_8 = User.create(username: 'Android 19' , email: 'jackdorsey@gmail.com', password: 'password', password_confirmation: 'password', jobtitle: "Andriod", biography: " Nineteenth android creation of an evil scientist", avatar: 'https://pm1.narvii.com/6331/e48e4b12345b6074850706bcc048f14ecad5da69_hq.jpg')
